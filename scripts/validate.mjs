...
execFileSync(process.execPath,['--test','scripts/radar.test.mjs','scripts/pricing.test.mjs','scripts/evidence.test.mjs','scripts/relay-comparison.test.mjs'],{stdio:'inherit'});
...
for(const f of ['src/radar-adapters.js','src/radar.js','dist/radar.js','dist/data/radar-sources.js','dist/app.js','dist/data/providers.js','dist/data/affiliate-programs.js','dist/data/affiliate-links.js'])execFileSync(process.execPath,['--check',f]);
