...
for(const f of ['src/radar.js','dist/radar.js','dist/data/radar-sources.js','dist/app.js','dist/data/providers.js','dist/data/affiliate-programs.js','dist/data/affiliate-links.js'])execFileSync(process.execPath,['--check',f]);
