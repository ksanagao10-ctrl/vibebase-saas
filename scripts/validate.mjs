...
execFileSync(process.execPath,['--test','scripts/operations.test.mjs','scripts/radar.test.mjs','scripts/pricing.test.mjs','scripts/evidence.test.mjs','scripts/relay-comparison.test.mjs'],{stdio:'inherit'});
for(const f of ['dist/relay-compare.js','src/pricing/relay-comparison.js','dist/discovery.js','dist/live-prices.js','dist/price-picker.js','dist/data/price-catalog.js','dist/data/discovery.js','dist/data/industry-workflows.js','dist/delivery-cost.js','dist/experience.js','dist/data/delivery-rates.js','dist/data/experience-meta.js','src/evidence.js','scripts/probe-relay.mjs','scripts/import-probe.mjs','src/worker.js','src/pricing/service.js','src/pricing/adapters.js','src/pricing/models.js','src/pricing/sources.js'])execFileSync(process.execPath,['--check',f]);
for(const f of ['dist/operations.js','dist/data/operations.js','src/radar-adapters.js','src/radar.js','dist/radar.js','dist/data/radar-sources.js','dist/app.js','dist/data/providers.js','dist/data/affiliate-programs.js','dist/data/affiliate-links.js'])execFileSync(process.execPath,['--check',f]);
