...
import {quoteCost,sortedQuotes,offerExpired,activeOffers,renderDiscovery,searchDiscovery,homeDiscovery} from '../dist/discovery.js';
...
for(const m of d.models){assert(providerIds.has(m.provider));for(const t of m.tasks)assert(taskIds.has(t));}
